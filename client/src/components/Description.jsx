        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>
                    ...
                    unique imagery, our tool transforms your text into eye-catching images with just a few clicks. Image it,
                ...
                <p className='text-gray-600'>
                    ...
                    From product visuals to character designs and potraits, even concepts that don't yet exist can be visualized
